...
export function IconAlert({ className, size = 22 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function IconTable({ className, size = 22 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function IconDownload({ className, size = 22 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
/** Overview / dashboard (2×2 tiles). */
export function IconLayoutDashboard({ className, size = 22 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
/** Add new item. */
export function IconCirclePlus({ className, size = 22 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
/** CSV / document export. */
export function IconFileDown({ className, size = 22 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function IconSprout({ className, size = 22 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
    ...
    >
      <path d="M7 20h10" />
      <path d="M10 20c5-6 2-12 2-12s-6 3-2 12" />
      <path d="M14 20c-5-6-2-12-2-12s6 3 2 12" />
    </svg>
  )
}
